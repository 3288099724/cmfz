    ...
    <script>
        ...
        $(function () {
            $("#loginButtonId").click(function () {
                ...
                var ad_name = $("#form-username").val();
                var ad_password = $("#form-password").val();
                console.log(enCode);
                console.log(ad_name);
                ...
                $.ajax({
                    ...
                    type: "post",
                    data: "ad_name=" + ad_name + "&ad_password=" + ad_password + "&enCode=" + enCode,
                    //dataType:"json",
                    success: function (data) {
                        console.log("success");
                        if (data.status) {
                            window.location.href = '/cmfz/back.jsp';
                        } else {
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <span id="message" style="color: #ff6329;"></span>
                            <span id="msgDiv"></span>
                            <div class="form-group">
                                <label class="sr-only" for="form-username">Username</label>
                                <input type="text" name="ad_name" placeholder="请输入用户名..."
                                       class="form-username form-control" id="form-username" required>
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="ad_password" placeholder="请输入密码..."
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 290px;height: 45px;border:3px solid #ddd;border-radius: 4px;"
