    ...
    <script>
        ...
        $(function () {
            $("#loginButtonId").click(function () {
                ...
                var user_name = $("#form-username").val();
                var user_password = $("#form-password").val();
                console.log(enCode);
                ...
                $.ajax({
                    ...
                    type: "post",
                    data: "user_name=" + user_name + "&user_password=" + user_password + "&enCode=" + enCode,
                    //dataType:"json",
                    success: function (data) {
                        console.log("success");
                        if (data.status) {
                            window.location.href = '/cmfz/index.html';
                        } else {
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>CMFZ</strong>User Login </h1>
